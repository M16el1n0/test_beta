...
// ═══ NFT ПОДАРКИ TELEGRAM ═══
const NFT_GIFTS = [
    { name: "Berry Box", type: "nft_berry_box", img: "/assets/nft/Berry Box.webp", starPrice: null },
    { name: "Big Year", type: "nft_big_year", img: "/assets/nft/Big Year.webp", starPrice: null },
    { name: "Bow Tie", type: "nft_bow_tie", img: "/assets/nft/Bow Tie.webp", starPrice: null },
    { name: "Bunny Muffin", type: "nft_bunny_muffin", img: "/assets/nft/Bunny Muffin.webp", starPrice: null },
    { name: "Clover Pin", type: "nft_clover_pin", img: "/assets/nft/Clover Pin.webp", starPrice: null },
    { name: "Cookie Heart", type: "nft_cookie_heart", img: "/assets/nft/Cookie Heart.webp", starPrice: null },
    { name: "Cupid Charm", type: "nft_cupid_charm", img: "/assets/nft/Cupid Charm.webp", starPrice: null },
    { name: "Durovs Cap", type: "nft_durovs_cap", img: "/assets/nft/Durovs Cap.webp", starPrice: null },
    { name: "Eternal Rose", type: "nft_eternal_rose", img: "/assets/nft/Eternal Rose.webp", starPrice: null },
    { name: "Fresh Socks", type: "nft_fresh_socks", img: "/assets/nft/Fresh Socks.webp", starPrice: null },
    { name: "Heroic Helmet", type: "nft_heroic_helmet", img: "/assets/nft/Heroic Helmet.webp", starPrice: null },
    { name: "Hypno Lollipop", type: "nft_hypno_lollipop", img: "/assets/nft/Hypno Lollipop.webp", starPrice: null },
    { name: "Ionic Dryer", type: "nft_ionic_dryer", img: "/assets/nft/Ionic Dryer.webp", starPrice: null },
    { name: "Kissed Frog", type: "nft_kissed_frog", img: "/assets/nft/Kissed Frog.webp", starPrice: null },
    { name: "Love Candle", type: "nft_love_candle", img: "/assets/nft/Love Candle.webp", starPrice: null },
    { name: "Lush Bouquet", type: "nft_lush_bouquet", img: "/assets/nft/Lush Bouquet.webp", starPrice: null },
    { name: "Mighty Arm", type: "nft_mighty_arm", img: "/assets/nft/Mighty Arm.webp", starPrice: null },
    { name: "Mousse Cake", type: "nft_mousse_cake", img: "/assets/nft/Mousse Cake.webp", starPrice: null },
    { name: "Perfume Bottle", type: "nft_perfume_bottle", img: "/assets/nft/Perfume Bottle.webp", starPrice: null },
    { name: "Pretty Posy", type: "nft_pretty_posy", img: "/assets/nft/Pretty Posy.webp", starPrice: null },
    { name: "Scared Cat", type: "nft_scared_cat", img: "/assets/nft/Scared Cat.webp", starPrice: null },
    { name: "Snoop Dogg", type: "nft_snoop_dogg", img: "/assets/nft/Snoop Dogg.webp", starPrice: null },
    { name: "Spring Basket", type: "nft_spring_basket", img: "/assets/nft/Spring Basket.webp", starPrice: null },
    { name: "Swag Bag", type: "nft_swag_bag", img: "/assets/nft/Swag Bag.webp", starPrice: null },
    { name: "Toy Bear", type: "nft_toy_bear", img: "/assets/nft/Toy Bear.webp", starPrice: null },
    { name: "Valentine Box", type: "nft_valentine_box_1", img: "/assets/nft/Valentine Box (1).webp", starPrice: null },
    { name: "Voodoo Doll", type: "nft_voodoo_doll", img: "/assets/nft/Voodoo Doll.webp", starPrice: null },
    { name: "Westside Sign", type: "nft_westside_sign", img: "/assets/nft/Westside Sign.webp", starPrice: null },
    { name: "Witch Hat", type: "nft_witch_hat", img: "/assets/nft/Witch Hat.webp", starPrice: null },
    { name: "Xmas Stocking", type: "nft_xmas_stocking", img: "/assets/nft/Xmas Stocking.webp", starPrice: null }
];

// Обновляем цены NFT каждые 30 минут
let _nftPriceCache = {};
let _nftPriceLastFetch = 0;

async function fetchNftPrices() {
    const now = Date.now();
    if (now - _nftPriceLastFetch < 30 * 60 * 1000 && Object.keys(_nftPriceCache).length > 0) {
        return _nftPriceCache;
    }
    try {
        const resp = await fetch(BACKEND_URL + '/nft_prices');
        if (resp.ok) {
            _nftPriceCache = await resp.json();
            _nftPriceLastFetch = now;
            console.log('NFT prices updated:', _nftPriceCache);
        }
    } catch(e) {
        console.warn('NFT prices fetch failed:', e.message);
    }
    return _nftPriceCache;
}

function getNftPrice(giftType) {
    return _nftPriceCache[giftType] || null;
}

// Запускаем обновление цен при старте и каждые 30 минут
setTimeout(() => {
    fetchNftPrices();
    setInterval(fetchNftPrices, 30 * 60 * 1000);
}, 3000);
