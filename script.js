    ...
    function renderMcGrid(gridId, items) {
        ...
        items.forEach(g => {
            ...
            card.innerHTML =
                ...
                (isSold
                    ? '<div class="inv-card-sub" style="color:#2a2a3a">продано</div>'
                    : '<div class="inv-card-sub">нажми чтобы продать</div>');
...
function showInventoryTab(tab) {
    ...
    document.querySelectorAll('.inv-tab-prf, .mc-inv-tab').forEach(b => b.classList.remove('active'));
...
function showGiftChoiceModal(gift, winAmount) {
    ...
    const sellPrice = winAmount; // полная сумма
