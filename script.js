...
function updateProfileGifts() {
    var EMOJIS = {bear:'🧸',heart:'❤️',rose:'🌹',gift:'🎁',cake:'🎂',
        champagne:'🥂',bouquet:'💐',cup:'🏆',ring:'💍',diamond:'💎',crown:'👑',rocket:'🚀',star:'⭐'};
    ...
    // DOM-метод — никаких проблем с кавычками внутри innerHTML
    grid.innerHTML = '';
    ...
    items.forEach(function(g) {
        ...
        eSpan.className = 'prf-gift-mini-emoji';
        eSpan.textContent = emoji;
        var vDiv = document.createElement('div');
        vDiv.className = 'prf-gift-mini-val';
        vDiv.textContent = '🟡 ' + (g.value || 0);
        var lDiv = document.createElement('div');
        lDiv.className = 'prf-gift-mini-lbl';
        lDiv.textContent = isW ? 'Выведен' : (g.name || 'Подарок');
        card.appendChild(eSpan);
