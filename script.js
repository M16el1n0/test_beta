...
function showGiftChoiceModal(gift, winAmount) {
    ...
    if (keepLbl) keepLbl.textContent = remainder > 0 ? `(+${remainder} F на баланс)` : '';
...
function keepGift() {
    ...
    // Остаток = сумма выигрыша - цена подарка
